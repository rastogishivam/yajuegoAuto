...
public class Ott_01_Ref_tappp_All_Tests extends Ref_App_Launch_Close {
    ...
    //@Test
    public void test_suite_1_TC01a_verify_Environment_Change_functionality() throws InterruptedException {
...
public void test_suite_1_TC03_verify_continue_button_before_entering_otp() throws InterruptedException {
    ...
    @Test
    public void test_suite_1_TC05_Verify_OTP_alphanumeric() throws InterruptedException {
    ...
    @Test
    public void test_suite_1_TC10_Verify_after_entering_correct_otp_user_able_to_land_on_change_profile_page() throws InterruptedException {
    ...
    @Test
    public void test_suite_2_TC11_checkUserAbleToClickOnChangeProfile() throws InterruptedException {
        extentTest = extent.startTest("Test_Suite_2_TC011 Verify user able to click on change profile or not");
        ...
        //pass the WebView name
        driver.context("NATIVE_APP");
        Assert.assertTrue(profile_page.test_change_profile(),"test_suite_2_TC11: failed, User is not able to change profile");
    }

    @Test
    public void test_suite_2_TC12_verify_user_able_to_login_before_entering_username_and_password() throws InterruptedException {
        extentTest = extent.startTest("Test_Suite_2_TC12 Verify login button before entering username and password");
        Set<String> contextHandles = driver.getContextHandles();
        boolean webviewFound = false;
        // Iterate through all context handles
        for (String contextName : contextHandles) {
        ...
        Assert.assertTrue(Login_page.login_button_disable_before_entering_username_password(),"Test case ref_tappp_03: failed, login button is enable before entering username and password");
    }

    @Test
    public void test_suite_2_TC13_verify_user_able_to_login_after_giving_wrong_username_and_password() throws InterruptedException {
        extentTest = extent.startTest("ref_tappp_13_verify_user_able_to_login_with_wrong_login_credentials");
        Set<String> contextHandles = driver.getContextHandles();
        boolean webviewFound = false;
        // Iterate through all context handles
        for (String contextName : contextHandles) {
        ...
        final var Login_page = new Login_Page(driver);
        Assert.assertTrue(Login_page.incorrect_login_credential(),"test_suite_2_TC13: failed, User is able to login with provided incorrect login credentials");
    }

    @Test
    public void test_suite_2_TC14_verify_user_able_to_login_after_giving_username_and_password() throws InterruptedException {
        extentTest = extent.startTest("ref_tappp_14_verify_user_able_to_login_for_bet_place");
        Set<String> contextHandles = driver.getContextHandles();
        boolean webviewFound = false;
        // Iterate through all context handles
        for (String contextName : contextHandles) {
        ...
        final var Login_page = new Login_Page(driver);
        Assert.assertTrue(Login_page.correct_login_credential(),"test_suite_2_TC14: failed, User is not able to login with correct credentials");
    }
    ...
    public void tear_Down(ITestResult result) throws IOException, InterruptedException {
        ...
        if (result.getStatus() == ITestResult.FAILURE) {
            ...
            if (result.getName().equals("test_suite_1_TC00_verify_Environment_Change_functionality")) {
                extentTest.log(LogStatus.INFO, "test_suite_1_TC00 failed: Actual Result: Environment Change not Successfull," +
                        " Expected Result: Environment Change Successfull");
            } else if (result.getName().equals("test_suite_1_TC01_verify_show_hide_panel_is_displaying_or_not")) {
            ...
            } else if (result.getName().equals("test_suite_2_TC11_checkUserAbleToClickOnChangeProfile")) {
                extentTest.log(LogStatus.INFO, "test_suite_2_TC11 failed: Actual Result: User not able to change profile successfully, Expected Result: User able to change profile successfully ");
            } else if (result.getName().equals("test_suite_2_TC12_verify_user_able_to_login_before_entering_username_and_password")) {
                extentTest.log(LogStatus.INFO, "test_suite_2_TC12 failed: Actual Result: User not getting 6 digit OTP, Expected Result: User should recieve 6 digit OTP ");
            } else if (result.getName().equals("test_suite_2_TC13_verify_user_able_to_login_after_giving_username_and_password")) {
                extentTest.log(LogStatus.INFO, "test_suite_2_TC13 failed: Actual Result: User not getting 6 digit OTP, Expected Result: User should recieve 6 digit OTP ");
            } else if (result.getName().equals("test_suite_2_TC14_verify_user_able_to_login_after_giving_username_and_password")) {
                extentTest.log(LogStatus.INFO, "test_suite_2_TC13 failed: Actual Result: User not getting 6 digit OTP, Expected Result: User should recieve 6 digit OTP ");
