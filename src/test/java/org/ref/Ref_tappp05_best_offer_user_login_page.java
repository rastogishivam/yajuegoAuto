...
public class Ref_tappp05_best_offer_user_login_page extends Ref_App_Launch_Close {

    public ExtentReports extent;
    public ExtentTest extentTest;

    @Test
    public void ref_tappp_12_verify_user_able_to_login_for_bet_place() throws InterruptedException {
        extentTest = extent.startTest("ref_tappp_12_verify_user_able_to_login_for_bet_place");
       ...
       // Assert.assertTrue(lp.access_accept(),"test case 12: failed, user is not able to login to place bet");
            }
