...
public class Ref_tappp_07_winner_bet_confirm extends Ref_App_Launch_Close {
    public ExtentReports extent;
    public ExtentTest extentTest;

    @Test
    public void ref_tappp_14_verify_winner1_place_bet_confirm_scenario() throws InterruptedException {
        extentTest = extent.startTest("ref_tappp_14_verify_winner1_place_bet_confirm_scenario");
        ...
        Assert.assertTrue(place_bet.place_bet_confirm_button(),"test case 14: failed, confirm place bet button is disable for winner1");
    }
    @Test
    public void ref_tappp_15_verify_winner2_place_bet_confirm_scenario() throws InterruptedException {
